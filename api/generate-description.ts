...
2. 出力前の必須チェック: 生成した文章をスキャンし、日本語以外の文字があれば削除または日本語に置換
3. 表現方法: 適切な日本語の類義語・同義語で表現
4. 注意: ふりがなや括弧での読み仮名表記は不要（普通の文章として記述）
...
【最終確認（出力前に必ずチェック）】
1. 文章全体をスキャンし、日本語以外の文字が含まれていないか確認
